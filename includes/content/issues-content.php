<section class="white">
	...
	<div class="inner-container">
		...
		<div class="row">		 			
				<ul class="issue__list col s12 m4">					
					<li class="issue__item"><a href="#united_nations">Remove the United Nations</a></li>
					<li class="issue__item"><a href="#education">Education</a></li>
					<li class="issue__item"><a href="#vaccinations">Vaccinations</a></li>
					<li class="issue__item"><a href="#homelessness">Homelessness and Poverty</a></li>
					<li class="issue__item"><a href="#weather_modification">Weather Modification</a></li>
					<li class="issue__item"><a href="#depopulation">UN Depopulation Plan</a></li>
					<li class="issue__item"><a href="#ban_gmo">Banning GMO's</a></li>
					<li class="issue__item"><a href="#seniors">Our Senior Citizens</a></li>
					<li class="issue__item"><a href="#economic_development">Economic Development</a></li>					
				</ul>
