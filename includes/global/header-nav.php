<header>
	<div class="inner-container">
		...
		<nav>
			...
			<a href="contact.php" class="<?if($page_id=="contact"){?>active<?}?>">Contact</a>
			<a href="media.php" class="<?if($page_id=="media"){?>active<?}?>">Media</a>
			<a href="donate.php" class="<?if($page_id=="donate"){?>active<?}?> donate-btn">Donate</a>
		</nav>
	</div>
</header>
